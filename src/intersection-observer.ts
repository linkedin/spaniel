...
export class SpanielIntersectionObserver implements IntersectionObserver {
  ...
  constructor(callback: Function, options: IntersectionObserverInit = {}, parentSpanielInstance: SpanielInstance) {
    this.records = {};
    ...
    if (this.parentSpanielInstance.getEngine().isOptimizedEngine) {
